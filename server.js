...
const template = (html, style) => `
    ...
    <head>
        ...
        <meta name="description" content="Giovanni Keppelen - Manager Front-end Enginner at Plurall" />
        <title>Giovanni Keppelen | Manager Front-end Enginner at Plurall</title>
        <style>${style}</style>
    </head>
    <body>
        ${html}
